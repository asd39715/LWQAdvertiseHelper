...
#import "LWQAdvertiseHelper.h"
#import "LWQAdvertiseView.h"

@implementation LWQAdvertiseHelper

+ (instancetype)sharedInstance{
    static LWQAdvertiseHelper* instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [LWQAdvertiseHelper new];
    });
    return instance;
}
...
+(void)showAdvertiserView:(NSArray *)imageArray{
    ...
    BOOL isExist = [[LWQAdvertiseHelper sharedInstance] isFileExistWithFilePath:filePath];
    if (isExist) {// 图片存在
